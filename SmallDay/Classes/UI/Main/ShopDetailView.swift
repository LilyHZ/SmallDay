...
class ShopDetailView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        middleLineView.backgroundColor = UIColor.redColor()//.colorWith(50, green: 50, blue: 50, alpha: 0.1)
        addSubview(middleLineView)
        
        bottomLineView = UIView()
        bottomLineView.backgroundColor = UIColor.blueColor()//.colorWith(50, green: 50, blue: 50, alpha: 1)
